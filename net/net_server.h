...
namespace net {
	...
	public:
		server_interface(uint16_t port)
			: /*m_asioSocket(m_asioContext),*/ m_asioAcceptor(m_asioContext, asio::ip::tcp::endpoint(asio::ip::tcp::v4(), port)) {
		...
		void MessageAllClients(message& msg, std::shared_ptr<connection<T>> pIgnoreClient = nullptr) {
